...
villas.each_with_index do |villa, i|
  Villa.create!(name: villa, city: cities[i], description: descriptions[i], address: addresses[i], price_per_day: ppd[i], rating: ratings[i])
end
...
reviews_stay = [
"4 jours à Miami",
"10 jours à l'Île Maurice",
"15 jours à Bahamas",
"8 jours à Los Angeles",
"7 jours à Val d'Isère"
]
...
villas.each do |villa|
  3.times do |i|
    r = Review.new(content: reviews.sample, title: reviews_title.sample, stay: reviews_stay.sample)
